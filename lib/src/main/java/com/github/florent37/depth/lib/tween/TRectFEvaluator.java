package com.github.florent37.depth.lib.tween;
...
public class TRectFEvaluator implements TypeEvaluator<RectF> {
    ...
    /**
     * This function returns the result of linearly interpolating the prepareAnimators and
     * end Rect values, with <code>fraction</code> representing the proportion
     * between the prepareAnimators and end values. The calculation is a simple parametric
     * calculation on each of the separate components in the Rect objects
     * (left, top, right, and bottom).
     *
     * @param fraction   The fraction from the starting to the ending values
     * @param startValue The prepareAnimators Rect
     * @param endValue   The end Rect
     * @return A linear interpolation between the prepareAnimators and end values, given the
